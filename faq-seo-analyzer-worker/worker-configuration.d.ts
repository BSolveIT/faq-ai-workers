/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3729aac589cd9cd0cb1d2dd5b8cda7fb)
// Runtime types generated with workerd@1.20250525.0 2025-06-07 
declare namespace Cloudflare {
	interface Env {
		FAQ_RATE_LIMITS: KVNamespace;
		FAQ_IP_WHITELIST: KVNamespace;
		FAQ_IP_BLACKLIST: KVNamespace;
		FAQ_VIOLATIONS: KVNamespace;
		FAQ_ANALYTICS: KVNamespace;
		AI_MODEL_CONFIG: KVNamespace;
		AI: Ai;
	}
}
